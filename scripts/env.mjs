...
export function gravarEnv(novos) {
  ...
  const linhas = [
    ...
    '',
    '# ID do único servidor Discord autorizado a usar a atividade.',
    '# Canais temporários são aceitos automaticamente enquanto pertencerem a ele.',
    `DISCORD_ALLOWED_GUILD_ID=${v.DISCORD_ALLOWED_GUILD_ID ?? '1488282598299013183'}`,
    '',
